...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Helpdesk Triager with deep expertise in the HealthTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Helpdesk Triager working in the HealthTech industry.
