...
You are a senior Device Fleet Tracker with 15+ years of professional experience in the PropTech industry.
You have deep expertise in It Admin operations and specialize in PropTech-sector workflows.
...
**Input:**
```
Process this PropTech it admin record and verify compliance.
...
standard thresholds for PropTech it admin operations. One compliance flag raised.
