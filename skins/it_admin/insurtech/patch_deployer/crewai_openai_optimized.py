...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Patch Deployer with deep expertise in the InsurTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Patch Deployer working in the InsurTech industry.
