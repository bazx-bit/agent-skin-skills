...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Network Alert Router with deep expertise in the InsurTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Network Alert Router working in the InsurTech industry.
