...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned User Provisioner with deep expertise in the InsurTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional User Provisioner working in the InsurTech industry.
