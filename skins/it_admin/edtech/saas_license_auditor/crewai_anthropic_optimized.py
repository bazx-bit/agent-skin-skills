...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned SaaS License Auditor with deep expertise in the EdTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional SaaS License Auditor working in the EdTech industry.
