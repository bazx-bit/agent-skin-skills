...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Patch Deployer with deep expertise in the CyberSecurity vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Patch Deployer working in the CyberSecurity industry.
