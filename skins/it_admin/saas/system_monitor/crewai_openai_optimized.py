...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned System Monitor with deep expertise in the SaaS vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional System Monitor working in the SaaS industry.
