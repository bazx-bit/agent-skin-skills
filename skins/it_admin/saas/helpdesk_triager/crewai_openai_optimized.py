...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Helpdesk Triager with deep expertise in the SaaS vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Helpdesk Triager working in the SaaS industry.
