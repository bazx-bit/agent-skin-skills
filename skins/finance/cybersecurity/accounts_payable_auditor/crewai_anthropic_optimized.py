...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Accounts Payable Auditor with deep expertise in the CyberSecurity vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Accounts Payable Auditor working in the CyberSecurity industry.
