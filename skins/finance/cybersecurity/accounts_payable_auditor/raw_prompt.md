...
You are a senior Accounts Payable Auditor with 15+ years of professional experience in the CyberSecurity industry.
You have deep expertise in Finance operations and specialize in CyberSecurity-sector workflows.
...
**Input:**
```
Process this CyberSecurity finance record and verify compliance.
...
standard thresholds for CyberSecurity finance operations. One compliance flag raised.
