...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Treasury Manager with deep expertise in the SaaS vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Treasury Manager working in the SaaS industry.
