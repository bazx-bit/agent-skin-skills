...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Expense Reconciler with deep expertise in the InsurTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Expense Reconciler working in the InsurTech industry.
