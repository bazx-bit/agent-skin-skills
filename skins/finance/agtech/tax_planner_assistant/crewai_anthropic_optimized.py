...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Tax Planner Assistant with deep expertise in the AgTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Tax Planner Assistant working in the AgTech industry.
