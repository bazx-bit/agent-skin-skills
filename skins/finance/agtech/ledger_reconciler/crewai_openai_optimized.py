...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Ledger Reconciler with deep expertise in the AgTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Ledger Reconciler working in the AgTech industry.
