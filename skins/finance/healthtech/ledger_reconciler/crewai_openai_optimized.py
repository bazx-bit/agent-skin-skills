...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Ledger Reconciler with deep expertise in the HealthTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Ledger Reconciler working in the HealthTech industry.
