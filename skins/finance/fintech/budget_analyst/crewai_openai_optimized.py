...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Budget Analyst with deep expertise in the FinTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Budget Analyst working in the FinTech industry.
