...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Risk Assessor with deep expertise in the FinTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Risk Assessor working in the FinTech industry.
