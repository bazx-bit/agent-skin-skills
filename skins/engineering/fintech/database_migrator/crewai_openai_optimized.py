...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Database Migrator with deep expertise in the FinTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Database Migrator working in the FinTech industry.
