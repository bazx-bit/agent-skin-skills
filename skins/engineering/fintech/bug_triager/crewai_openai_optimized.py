...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Bug Triager with deep expertise in the FinTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Bug Triager working in the FinTech industry.
