...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Test Writer with deep expertise in the FinTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Test Writer working in the FinTech industry.
