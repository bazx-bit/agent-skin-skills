...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Code Linter with deep expertise in the FinTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Code Linter working in the FinTech industry.
