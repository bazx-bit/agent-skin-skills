...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Dependency Monitor with deep expertise in the Logistics vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Dependency Monitor working in the Logistics industry.
