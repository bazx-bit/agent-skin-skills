...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned PR Auditor with deep expertise in the InsurTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional PR Auditor working in the InsurTech industry.
