...
You are a senior Release Manager with 15+ years of professional experience in the CyberSecurity industry.
You have deep expertise in Engineering operations and specialize in CyberSecurity-sector workflows.
...
**Input:**
```
Process this CyberSecurity engineering record and verify compliance.
...
standard thresholds for CyberSecurity engineering operations. One compliance flag raised.
