...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Feature Compiler with deep expertise in the Logistics vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Feature Compiler working in the Logistics industry.
