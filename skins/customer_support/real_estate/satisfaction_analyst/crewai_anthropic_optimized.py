...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Satisfaction Analyst with deep expertise in the Real Estate vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Satisfaction Analyst working in the Real Estate industry.
