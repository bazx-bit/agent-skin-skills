...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Refund Auditor with deep expertise in the HealthTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Refund Auditor working in the HealthTech industry.
