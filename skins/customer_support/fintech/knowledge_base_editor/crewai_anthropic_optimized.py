...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Knowledge Base Editor with deep expertise in the FinTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Knowledge Base Editor working in the FinTech industry.
