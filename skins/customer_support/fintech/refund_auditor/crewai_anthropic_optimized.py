...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Refund Auditor with deep expertise in the FinTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Refund Auditor working in the FinTech industry.
