...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned FAQ Answerer with deep expertise in the FinTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional FAQ Answerer working in the FinTech industry.
