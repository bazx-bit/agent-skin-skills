...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned SEO Specialist with deep expertise in the BioTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional SEO Specialist working in the BioTech industry.
