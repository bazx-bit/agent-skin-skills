...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Ad Copy Writer with deep expertise in the CyberSecurity vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Ad Copy Writer working in the CyberSecurity industry.
