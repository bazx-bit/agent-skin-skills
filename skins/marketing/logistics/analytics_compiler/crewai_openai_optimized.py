...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Analytics Compiler with deep expertise in the Logistics vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Analytics Compiler working in the Logistics industry.
