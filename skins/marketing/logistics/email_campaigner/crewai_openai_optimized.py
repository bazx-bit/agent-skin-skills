...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Email Campaigner with deep expertise in the Logistics vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Email Campaigner working in the Logistics industry.
