...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Content Strategist with deep expertise in the Logistics vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Content Strategist working in the Logistics industry.
