...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Competitor Monitor with deep expertise in the InsurTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Competitor Monitor working in the InsurTech industry.
