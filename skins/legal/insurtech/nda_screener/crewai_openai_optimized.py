...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned NDA Screener with deep expertise in the InsurTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional NDA Screener working in the InsurTech industry.
