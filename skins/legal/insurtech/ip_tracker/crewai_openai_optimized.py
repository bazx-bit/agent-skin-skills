...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned IP Tracker with deep expertise in the InsurTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional IP Tracker working in the InsurTech industry.
