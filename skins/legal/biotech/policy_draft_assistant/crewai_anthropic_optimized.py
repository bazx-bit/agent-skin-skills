...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Policy Draft Assistant with deep expertise in the BioTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Policy Draft Assistant working in the BioTech industry.
