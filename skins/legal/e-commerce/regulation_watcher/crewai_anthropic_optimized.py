...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Regulation Watcher with deep expertise in the E-commerce vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Regulation Watcher working in the E-commerce industry.
