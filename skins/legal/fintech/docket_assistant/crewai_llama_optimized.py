...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Docket Assistant with deep expertise in the FinTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Instructions:
Identity: You are a professional Docket Assistant working in the FinTech industry.
