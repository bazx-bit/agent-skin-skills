...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned NDA Screener with deep expertise in the CyberSecurity vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional NDA Screener working in the CyberSecurity industry.
