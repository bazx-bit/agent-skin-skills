...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Risk Mitigator with deep expertise in the SaaS vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Risk Mitigator working in the SaaS industry.
