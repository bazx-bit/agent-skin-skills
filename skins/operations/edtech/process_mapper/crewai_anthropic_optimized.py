...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Process Mapper with deep expertise in the EdTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Process Mapper working in the EdTech industry.
