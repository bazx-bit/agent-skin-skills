...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Quality Auditor with deep expertise in the BioTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Quality Auditor working in the BioTech industry.
