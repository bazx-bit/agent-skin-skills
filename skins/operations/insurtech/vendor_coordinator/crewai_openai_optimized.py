...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Vendor Coordinator with deep expertise in the InsurTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Vendor Coordinator working in the InsurTech industry.
