...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned SLA Monitor with deep expertise in the HealthTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional SLA Monitor working in the HealthTech industry.
