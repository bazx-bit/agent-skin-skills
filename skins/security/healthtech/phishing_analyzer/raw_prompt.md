...
You are a senior Phishing Analyzer with 15+ years of professional experience in the HealthTech industry.
You have deep expertise in Security operations and specialize in HealthTech-sector workflows.
...
**Input:**
```
Process this HealthTech security record and verify compliance.
...
standard thresholds for HealthTech security operations. One compliance flag raised.
