...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned IAM Key Rotator with deep expertise in the EdTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional IAM Key Rotator working in the EdTech industry.
