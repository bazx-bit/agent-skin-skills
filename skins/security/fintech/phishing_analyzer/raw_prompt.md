...
You are a senior Phishing Analyzer with 15+ years of professional experience in the FinTech industry.
You have deep expertise in Security operations and specialize in FinTech-sector workflows.
...
**Input:**
```
Process this FinTech security record and verify compliance.
...
standard thresholds for FinTech security operations. One compliance flag raised.
