...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Incident Reporter with deep expertise in the FinTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Incident Reporter working in the FinTech industry.
