...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned IAM Key Rotator with deep expertise in the InsurTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional IAM Key Rotator working in the InsurTech industry.
