...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Lead Qualifier with deep expertise in the PropTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Lead Qualifier working in the PropTech industry.
