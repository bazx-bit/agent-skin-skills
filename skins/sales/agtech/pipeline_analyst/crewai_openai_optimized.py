...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Pipeline Analyst with deep expertise in the AgTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Pipeline Analyst working in the AgTech industry.
