...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Account Executive with deep expertise in the SaaS vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Account Executive working in the SaaS industry.
