...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Demo Coordinator with deep expertise in the CyberSecurity vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Demo Coordinator working in the CyberSecurity industry.
