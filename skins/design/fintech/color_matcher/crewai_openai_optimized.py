...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Color Matcher with deep expertise in the FinTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Color Matcher working in the FinTech industry.
