...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned SVG Generator with deep expertise in the HealthTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional SVG Generator working in the HealthTech industry.
