...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned UI Specs Checker with deep expertise in the HealthTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional UI Specs Checker working in the HealthTech industry.
