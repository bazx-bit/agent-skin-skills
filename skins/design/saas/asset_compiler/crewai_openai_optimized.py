...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Asset Compiler with deep expertise in the SaaS vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Asset Compiler working in the SaaS industry.
