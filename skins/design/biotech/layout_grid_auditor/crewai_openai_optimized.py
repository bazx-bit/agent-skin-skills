...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Layout Grid Auditor with deep expertise in the BioTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Layout Grid Auditor working in the BioTech industry.
