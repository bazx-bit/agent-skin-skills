...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Logo Pitcher with deep expertise in the InsurTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Logo Pitcher working in the InsurTech industry.
