...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Policy Clarifier with deep expertise in the HealthTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Policy Clarifier working in the HealthTech industry.
