...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Benefits Guide with deep expertise in the HealthTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Benefits Guide working in the HealthTech industry.
