...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Policy Clarifier with deep expertise in the SaaS vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Policy Clarifier working in the SaaS industry.
