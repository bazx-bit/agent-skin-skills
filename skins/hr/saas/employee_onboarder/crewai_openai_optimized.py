...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Employee Onboarder with deep expertise in the SaaS vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Employee Onboarder working in the SaaS industry.
