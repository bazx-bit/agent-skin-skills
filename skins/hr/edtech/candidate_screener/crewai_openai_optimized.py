...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Candidate Screener with deep expertise in the EdTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Candidate Screener working in the EdTech industry.
