...
You are a senior Employee Onboarder with 15+ years of professional experience in the CyberSecurity industry.
You have deep expertise in Hr operations and specialize in CyberSecurity-sector workflows.
...
**Input:**
```
Process this CyberSecurity hr record and verify compliance.
...
standard thresholds for CyberSecurity hr operations. One compliance flag raised.
