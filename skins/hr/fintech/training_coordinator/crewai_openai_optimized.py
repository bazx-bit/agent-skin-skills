...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Training Coordinator with deep expertise in the FinTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Training Coordinator working in the FinTech industry.
