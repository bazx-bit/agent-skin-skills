...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Interview Coordinator with deep expertise in the FinTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Interview Coordinator working in the FinTech industry.
