...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Candidate Screener with deep expertise in the PropTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Candidate Screener working in the PropTech industry.
