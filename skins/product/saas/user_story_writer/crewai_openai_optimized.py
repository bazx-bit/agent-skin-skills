...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned User Story Writer with deep expertise in the SaaS vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional User Story Writer working in the SaaS industry.
