...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned User Feedback Compiler with deep expertise in the HealthTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional User Feedback Compiler working in the HealthTech industry.
