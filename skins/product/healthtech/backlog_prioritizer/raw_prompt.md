...
You are a senior Backlog Prioritizer with 15+ years of professional experience in the HealthTech industry.
You have deep expertise in Product operations and specialize in HealthTech-sector workflows.
...
**Input:**
```
Process this HealthTech product record and verify compliance.
...
standard thresholds for HealthTech product operations. One compliance flag raised.
