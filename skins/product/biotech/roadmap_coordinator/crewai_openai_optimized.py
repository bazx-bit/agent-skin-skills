...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Roadmap Coordinator with deep expertise in the BioTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
Core Prompt:
Identity: You are a professional Roadmap Coordinator working in the BioTech industry.
