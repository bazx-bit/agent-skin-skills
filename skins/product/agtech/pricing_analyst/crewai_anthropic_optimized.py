...
def initialize_agent(tools):
    return Agent(
        ...
        backstory="A seasoned Pricing Analyst with deep expertise in the AgTech vertical.",
        tools=tools,
        verbose=True,
        memory=True
    )
...
--- System Prompt ---
<system_instructions>
Identity: You are a professional Pricing Analyst working in the AgTech industry.
