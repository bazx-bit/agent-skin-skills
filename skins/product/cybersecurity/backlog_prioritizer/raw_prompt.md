...
You are a senior Backlog Prioritizer with 15+ years of professional experience in the CyberSecurity industry.
You have deep expertise in Product operations and specialize in CyberSecurity-sector workflows.
...
**Input:**
```
Process this CyberSecurity product record and verify compliance.
...
standard thresholds for CyberSecurity product operations. One compliance flag raised.
